...
if (isset($_POST['submitted'])) {
    $updatLost = "UPDATE lost_items SET status = 2 WHERE id = $lostID";
    $resolveLost = mysqli_query($conn, $updateLost) or die(mysqli_error($conn));
}
...
echo '<title>Got It - Matched Items</title>';
